...
def load_watchlist_symbols(file_path="credit_spread.txt"):
    ...
    if not os.path.exists(file_path):
        # Safe default fallback if the file hasn't been populated yet
    ...
    try:
        async with DXLinkStreamer(session) as streamer:
            while True:
                ...
                print(f" {BOLD_WHITE}               AJ CAPITAL LLC - BULL PUT CREDIT SPREAD MONITOR & DATA DASHBOARD [{env_mode}]{RESET}")
                print(f"{BOLD_WHITE}========================================================================================================================{RESET}")
                ...
                for sym in watchlist:
                    ...
                    if underlying_price > 0:
                        ...
                        # Build your clean vertical credit spread strikes
